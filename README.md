...
Self-hosted wiki: роли **Admin / Editor / Viewer**, пространства **space**, дерево страниц, JSON-блоки контента (MVP), версии страниц, комментарии, публикация по публичной ссылке `/pub/:token`.
